plot4 <- function () {
  ...
  # plot line graph Global_active_power
    plot(yrange, xglobalactivepower, type="l",  ylab='Global Active Power (killowatts)',xlab="", cex.lab= 0.8) 
  
  # plot line graph for Voltage
    plot(yrange, xvoltage, type="l",  ylab='Voltage', xlab='datetime') 
  ...
  # plot line graph for Submetering variables 
    ...
    legend("topright", c('Sub_metering_1','Sub_metering_2','Sub_metering_3'), cex=0.3, col=c('black','red','blue'), lwd=2)
  
    plot(yrange, xglobalreactivepower, type="l",  ylab='Global_reactive_power', xlab='datetime') 
